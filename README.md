...
Серия экспериментов Exp0.1–Exp0.8 **завершена**. Результаты консолидированы в документацию v1.7. Система валидирована: адаптивное уточнение работает и превосходит random selection при ограниченном бюджете. В v1.6 добавлен (обновлён в v1.7) Scale-Consistency Invariant — формализация требования «не сломать фичи».
...
docs/
  ...
  concept_v1.7.md                  — концептуальный документ (канонический)
...
2. **`docs/concept_v1.7.md`** — каноническая концепция (все валидированные решения)
