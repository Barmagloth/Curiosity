#!/usr/bin/env python3
"""E2E validation: tree_hierarchy — 20 seeds x 3 budgets."""
...
# Tree has known high reject rate — report but don't auto-fail
rr_max = summary['reject_rate_max'] or 0
print(f"  Reject rate: {rr_max:.1%} (tree has known high reject rate due to tight T4 thresholds)")
