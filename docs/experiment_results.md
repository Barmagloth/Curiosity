...
**Результат:** Да. Halo ≥ 3 пикселя при tile_size=16 устраняет артефакты. Interior-only HF-метрика подтвердила: проблема именно в швах, а не во внутренней части тайлов.
